...
def init_db():
    ...
    from models import document, report, research_session, debate, digest_settings, model_settings, reminder, user, audit_log, custom_persona, model_catalog  # noqa: F401
